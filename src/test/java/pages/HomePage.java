...
//    public WebElement UzunAciklama;
 ...
 public WebElement sepeteEklenecekUrunElementi;*/
    ...
    @FindBy(xpath = "//button[@value='Giriş Yap']") public WebElement zgirisYapButonu2;
    @FindBy(xpath = "/html/body/div[1]/div[2]/ul/li[3]") public WebElement zhesabım2Butonu;
    //@FindBy(xpath = "//*[@id=\"menu-item-1074\"]/a")
    // public WebElement  hesabimlinktext;
    @FindBy(xpath = "(//div[@class='icon-box text-center'])[2]") public WebElement zsiparislerKutusu;
    @FindBy(xpath = "(//*[.='Siparişler'])[1]") public WebElement zpanodakiSiparislerSekmesi;
    @FindBy(xpath = "//li[@class='woocommerce-MyAccount-navigation-link woocommerce-MyAccount-navigation-link--downloads']") public WebElement zpanodakiIndirmelerSekmesi;
    @FindBy(xpath = "//li[@class='woocommerce-MyAccount-navigation-link woocommerce-MyAccount-navigation-link--edit-address']") public WebElement zpanodakiAdresSekmesi;
    @FindBy(xpath = "//table[@class='woocommerce-orders-table woocommerce-MyAccount-orders shop_table shop_table_responsive my_account_orders account-orders-table']") public WebElement zsiparisTablosu;
    @FindBy(xpath = "//div[@class='icon-box icon-box-side woocommerce-MyAccount-content-caption justify-content-start mb-4']") public WebElement zspiarislerYazisi;
    @FindBy(xpath = "//h4[@class='icon-box-title text-normal']") public WebElement zindirmelerYazisi;
    @FindBy(xpath = "//*[@id=\"main\"]/div/div/div/div/div/div/div") public WebElement zadreslerTablosu;
    @FindBy(xpath = "//*[@id=\"main\"]/div/div/div/div/div/div/div/div[3]/div[1]/div") public WebElement zfaturaAdresiTablosu;
